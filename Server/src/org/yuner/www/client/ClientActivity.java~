...
public class ClientActivity {
	...
	private boolean mIsSavingAndClosing;
	...
	public void startHandShake(String msg0) {
		...
		System.out.println(mUsrInfo.getName + " is now online");
	}
	...
	public void goOffLine() {
		if(mIsSavingAndClosing) {
			return;
		}
		mIsSavingAndClosing = true;
		...
		System.out.println(mUsrInfo.getName + " is now offline");
		mIsSavingAndClosing = false;
	}
